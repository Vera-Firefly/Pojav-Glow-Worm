...
// https://github.com/termux/termux-app/blob/master/termux-shared%2Fsrc%2Fmain%2Fjava%2Fcom%2Ftermux%2Fshared%2Fview%2FKeyboardUtils.java#L3-L198
        ...
        if (activity != null && activity.getWindow() != null) {
            ...
            if (insets != null) {
                ...
                if (insetsCompat.isVisible(WindowInsetsCompat.Type.ime())) {
                    Log.d(LOG_TAG, "Soft keyboard visible");
                    return true;
                }
            }
        }

        Log.d(LOG_TAG, "Soft keyboard not visible");
        return false;
    }
    ...
    public static boolean shouldSoftKeyboardBeDisabled(final Context context, final boolean isSoftKeyboardEnabled, final boolean isSoftKeyboardEnabledOnlyIfNoHardware) {
        ...
        if (!isSoftKeyboardEnabled) {
            ...
            if(isSoftKeyboardEnabledOnlyIfNoHardware) {
                ...
                Log.d(LOG_TAG, "Hardware keyboard connected=" + isHardKeyboardConnected);
