...
public class JREUtils {
    ...
    public static void setJavaEnvironment(Activity activity, String jreHome) throws Throwable {
        ...
        if (LOCAL_RENDERER != null) {
            envMap.put("MESA_GL_VERSION_OVERRIDE", LOCAL_RENDERER.equals("opengles3_virgl")?"4.6":"4.6");
            envMap.put("MESA_GLSL_VERSION_OVERRIDE", LOCAL_RENDERER.equals("opengles3_virgl")?"460":"460");
        }
