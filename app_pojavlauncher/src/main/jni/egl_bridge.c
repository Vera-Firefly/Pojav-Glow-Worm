//
// Modifile by Vera-Firefly on 18.11.2023.
//
#include <jni.h>
#include <assert.h>
#include <dlfcn.h>
...
EXTERNAL_API void* pojavGetCurrentContext() {
    ...
    } else if(pojav_environ->config_renderer == RENDERER_VK_WARLIP || pojav_environ->config_renderer == RENDERER_VIRGL) {
...
/* window==0 ? EGL_NO_CONTEXT : */
    ...
    if (pojav_environ->config_renderer == RENDERER_VK_WARLIP || pojav_environ->config_renderer == RENDERER_VIRGL) {
