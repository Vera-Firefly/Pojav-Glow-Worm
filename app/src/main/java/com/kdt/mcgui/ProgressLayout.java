...
import net.kdt.pojavlaunch.firefly.progresskeeper.ProgressListener;
...
public class ProgressLayout extends ConstraintLayout implements View.OnClickListener, TaskCountListener {
    ...
    public static final String CHECK_MODS = "check_mods";
    ...
    public static final String MINECRAFT_VERSION_REPAIR = "minecraft_version_repair";
